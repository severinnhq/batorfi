...
import Bonuses from '@/components/hu/bonuses';
import Why from "@/components/hu/why";
import Cta1Section from "@/components/hu/cta1section";
import Cta2Section from "@/components/hu/cta2section";
...
>
  <div className="text-3xl min-[360px]:text-4xl xl:text-5xl 2xl:text-6xl">
    Allonx <span className="text-white">offer</span>
  </div>
