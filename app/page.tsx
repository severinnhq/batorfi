...
export default function DigitalMarketingQuiz() {
  ...
  const iconMap: Record<string, string> = {
    ...
    instagram: 'https://cdn-icons-png.flaticon.com/512/6033/6033716.png',
  ...
  return (
    <main className="spacer layer1 bg-no-repeat bg-center bg-contain bg-scroll md:bg-auto md:bg-fixed">
      <LandingHeader />
      ...
      <div
        ref={topSectionRef}
        className="
          w-full px-8 sm:px-16 md:px-32 lg:px-16 
          flex flex-col justify-between items-center 
          pt-12 md:pt-16 lg:pt-24 
          relative bg-cover bg-center bg-no-repeat
        "
        style={{ backgroundImage: "url('/uploads/lovjahero.png')" }}
      >
            ...
            >
              ...
              >
                <div className="text-3xl min-[360px]:text-4xl xl:text-5xl 2xl:text-6xl">
                  Lovja <span className="text-white">offer</span>
                </div>
