        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            <ul className="space-y-3 text-base text-white/90 leading-relaxed">
              <li>✅ Mert az online térben ma a figyelemért folyik a harc — és a Lovja segít Önnek nyerni.</li>
              <li>✅ Mert a páciensek 80%-a az interneten dönt, mielőtt bármit foglalna.</li>
              <li>✅ Mert egy modern, adatvezérelt marketingrendszer nélkül a konkurencia viszi el a lehetőségeket.</li>
              <li>✅ Mert a Lovja rendszere nem csak hirdet – <span className="font-semibold text-white">automatikusan konvertál</span>.</li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-3 text-base text-white/90 leading-relaxed">
              <li>⚠️ A versenytársai hirdetései előzik meg az Önéit, így a páciensek őket választják.</li>
              <li>⚠️ A hónapról hónapra növekvő hirdetési költségek mellett <span className="font-semibold text-white">csökkenő eredményekkel</span> kell számolnia.</li>
              <li>⚠️ A klinika online jelenléte elavultnak hat, és a bizalomvesztés azonnali.</li>
              <li>⚠️ Minden egyes elmaradt érdeklődő egy elveszített lehetőség — <span className="font-semibold text-yellow-400">amelyet valaki más nyer meg.</span></li>
            </ul>
          </motion.div>
        </div>
